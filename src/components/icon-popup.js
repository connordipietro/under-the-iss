...
const PopupModalForParts = (props) => {
  return (
    <>
      <Modal {...props} size="lg" centered animation>
...
const PopupModalForSizeInfo = (props) => {
  return (
     <>
       <Modal {...props} size="md" centered animation>
